...
/// reached" Will be raised if a required db server can't be reached.
...
constexpr int TRI_ERROR_CLUSTER_MUST_NOT_DROP_COLL_OTHER_DISTRIBUTESHARDSLIKE =
    1485;
...
/// value must be prefixed with the value of the smart join attribute.
